...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    <div className={`w-60 <div className="bg-gradient-to-b from-white via-sky-100 to-sky-50">
 border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ?'translate-x-0':'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
